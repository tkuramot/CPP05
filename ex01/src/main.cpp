...
int main() {
  {
    ...
    //(Bureaucrat::GradeTooHighException &e) { 		std::cout << e.what() <<
    //std::endl;
    //	  }
    //	}
    //	{
    ...
    //(Bureaucrat::GradeTooLowException &e) { 		std::cout << e.what() <<
    //std::endl;
    //	  }
    //	}
    //  }
    ...
    //<< "Bureaucrat promoted by 40 grade" << std::endl; 	  b.Promote(40);
    //	  std::cout << b << std::endl;
